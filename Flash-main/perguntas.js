...
criaCartao(
    'DC ou Marvel?',
    'Qual é a fraqueza do Batman?',
    'As pessoas que ele cria um laço'
)
criaCartao(
    'DC ou Marvel?',
    'Qual das franquias possui os melhores Super-Heróis?',
    'DC, não se engane.'
)
criaCartao(
    'DC ou Marvel?',
    'Qual dos universos tem os melhores filmes?',
    'Marvel'
)
criaCartao(
    'DC ou Marvel?',
    'Qual dos universos tem as melhores séries?',
    'DC'
)
criaCartao(
    'DC ou Marvel?',
    'Qual a melhor pessoa pro Batman?',
    'É a Batgirl.'
)
criaCartao(
    'DC ou Marvel?',
    'Qual o filme que mais acumulou dinheiro pra Marvel',
    'Vingadores, Ultimato'
)
criaCartao(
    'JOGOS',
